...
<%
	MaterialPropertyOptionBean propertyOptionBean = (MaterialPropertyOptionBean) request.getAttribute("propertyOptionBean");
	//分类属性类型
...
<body class="article_bg">
	...
	<form id="formData" name="formData" method="post" action="MaterialPropertyOptionManage.do" onsubmit="javascript:return checkForm('formData');">
		...
		<div class="div_center">
			<input style="width: 50px;" type="submit" name="submit" id="submit" class="modifysubbtn" value="提交" />
			<a href="MaterialPropertyOptionList.do?propertyId=<%=propertyId%>&readOnly=<%=readOnly%>"><input style="width: 50px;" type="button" name="cancel" id="cancel" class="modifysubbtn" value="返回" /></a>
		</div>
	</form>
