...
@WebServlet("/pdm/BarcodeInfoList.do")
public class BarcodeInfoList extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public BarcodeInfoList() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher(PdmConfig.PAGE_PATH + "BarcodeInfoList.jsp");
