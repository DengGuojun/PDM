...
public final class PdmServicePrxHelper extends Ice.ObjectPrxHelperBase implements PdmServicePrx {
	...
	public Ice.AsyncResult begin_rpc(String method, String params, Callback_PdmService_rpc __cb) {
		return begin_rpc(method, params, null, false, false, __cb);
	}

	public Ice.AsyncResult begin_rpc(String method, String params, java.util.Map<String, String> __ctx,
			Callback_PdmService_rpc __cb) {
		return begin_rpc(method, params, __ctx, true, false, __cb);
	}
	...
	private Ice.AsyncResult begin_rpc(String method, String params, java.util.Map<String, String> __ctx,
			boolean __explicitCtx, boolean __synchronous, IceInternal.Functional_GenericCallback1<String> __responseCb,
			IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb,
			IceInternal.Functional_BoolCallback __sentCb) {
		return begin_rpc(method, params, __ctx, __explicitCtx, __synchronous,
				new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb) {
					public final void __completed(Ice.AsyncResult __result) {
						PdmServicePrxHelper.__rpc_completed(this, __result);
					}
				});
	}
	...
	static public void __rpc_completed(Ice.TwowayCallbackArg1<String> __cb, Ice.AsyncResult __result) {
		com.lpmas.pdm.component.PdmServicePrx __proxy = (com.lpmas.pdm.component.PdmServicePrx) __result.getProxy();
		String __ret = null;
		try {
	...
	public static PdmServicePrx checkedCast(Ice.ObjectPrx __obj) {
		return checkedCastImpl(__obj, ice_staticId(), PdmServicePrx.class, PdmServicePrxHelper.class);
	}

	public static PdmServicePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx) {
		return checkedCastImpl(__obj, __ctx, ice_staticId(), PdmServicePrx.class, PdmServicePrxHelper.class);
	}

	public static PdmServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet) {
		return checkedCastImpl(__obj, __facet, ice_staticId(), PdmServicePrx.class, PdmServicePrxHelper.class);
	}

	public static PdmServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx) {
		return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), PdmServicePrx.class, PdmServicePrxHelper.class);
	}

	public static PdmServicePrx uncheckedCast(Ice.ObjectPrx __obj) {
		return uncheckedCastImpl(__obj, PdmServicePrx.class, PdmServicePrxHelper.class);
	}

	public static PdmServicePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet) {
		return uncheckedCastImpl(__obj, __facet, PdmServicePrx.class, PdmServicePrxHelper.class);
	}

	public static final String[] __ids = { "::Ice::Object", "::com::lpmas::pdm::component::PdmService" };

	public static String ice_staticId() {
		return __ids[1];
	}

	public static void __write(IceInternal.BasicStream __os, PdmServicePrx v) {
		__os.writeProxy(v);
	}

	public static PdmServicePrx __read(IceInternal.BasicStream __is) {
		Ice.ObjectPrx proxy = __is.readProxy();
		if (proxy != null) {
			PdmServicePrxHelper result = new PdmServicePrxHelper();
