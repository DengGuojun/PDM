...
public class PropertyInputDisplayOutsourceImpl extends PropertyInputDisplay {

	@Override
	public String getPropertyInputStr(Object PropertyTypeBean, Object PropertyBean, boolean isSubType) {
		String fileName = null;
		fileName = "outsourceInputDisplay.html";
		...
		contentMap.put("outerUrl", invoke(PropertyTypeBean, "getFieldSource"));
