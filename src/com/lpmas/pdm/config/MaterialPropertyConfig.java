...
public class MaterialPropertyConfig {
	...
	// 信息类型
	public static final int INFO_TYPE_PRODUCT = 1; // 商品信息
	public static final int INFO_TYPE_ITEM = 2; // 商品项信息
	...
	private static void initInfoTypeList() {
		...
		INFO_TYPE_LIST.add(new StatusBean<Integer, String>(INFO_TYPE_PRODUCT, "商品"));
		INFO_TYPE_LIST.add(new StatusBean<Integer, String>(INFO_TYPE_ITEM, "商品项"));
	}
